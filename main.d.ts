export = ClaudeAPIInst;
export as namespace ClaudeAPI;

declare class ClaudeAPIInst {
    constructor(APIKey: string)
    public sendMessage(text: string, conversationId?: string, options?: ClaudeAPIInst.Options): Promise<ClaudeAPIInst.ClaudeAPIResponse>;
    ...
    */
    public getConversation(conversationId: string): string;

    /**
    * Delete the conversation specified by `conversationId`
    * @param conversationId 
    */
    public delConversation(conversationId: string): void;

    public initConversationCache(): string;
    protected key: string;
}



declare namespace ClaudeAPIInst {
